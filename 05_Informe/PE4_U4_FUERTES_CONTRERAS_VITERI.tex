...
\begin{document}
	...
	El proyecto se versiona en el repositorio
	\url{https://github.com/MiloSaurio4kHD/ISR401-PFC-ERS-EQUIPO-E}, con una única rama
	\texttt{main} y estructura de carpetas alineada con las entregas de la PE4:
	\texttt{01\_ERS}, \texttt{02\_Inspeccion}, \texttt{03\_CCB}, \texttt{04\_Trazabilidad},
	\texttt{05\_Informe} y \texttt{06\_Evidencias}, más un \texttt{CHANGELOG.md} y un
	\texttt{README.md} en la raíz. Los tres integrantes disponen de acceso de escritura y firman sus
	commits con su cuenta institucional o personal vinculada a GitHub.
	
	\subsection{Commits semánticos}
	
	El historial sigue la convención de \emph{commits} semánticos (\texttt{docs}, \texttt{chore})
	utilizada durante toda la práctica. A la fecha de cierre de esta sección el repositorio registra 18
	...
	\begin{table}[H]
		...
		\begin{tabular}{L{3.8cm} L{6.0cm} L{1.6cm} L{1.6cm}}
			...
			correcciones al ERS v1.1 & 5,0 & 6 \\
			\addlinespace
			...
			\midrule
			\textbf{Total} & & \textbf{12,0} & \textbf{18} \\
			\bottomrule
		\end{tabular}
	\end{table}
